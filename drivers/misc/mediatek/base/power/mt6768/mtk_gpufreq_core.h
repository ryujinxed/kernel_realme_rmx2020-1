 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0			(1075000)	/* KHz */
...
#define SEG_GPU_DVFS_FREQ6			(925000)	/* KHz */
#define SEG_GPU_DVFS_FREQ7			(900000)	/* KHz */
#define SEG_GPU_DVFS_FREQ8			(875000)	/* KHz */
#define SEG_GPU_DVFS_FREQ9			(850000)	/* KHz */
#define SEG_GPU_DVFS_FREQ10			(823000)	/* KHz */
#define SEG_GPU_DVFS_FREQ11			(796000)	/* KHz */
#define SEG_GPU_DVFS_FREQ12			(769000)	/* KHz */
#define SEG_GPU_DVFS_FREQ13			(743000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT4		(92500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT5		(90000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT6		(87500)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VOLT12		(76875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT13		(75625)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VOLT31		(63125)		/* mV x 100 */
